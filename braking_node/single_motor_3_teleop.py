...
def show_information(m3, s3, sp1):
    if s3 == 1:
        s3 = "ON"
    else:
        s3 = "OFF"

    print('M3: {}% ({}) speed: {}'.format(m3, s3, sp1))
...
def main():
    ...
    try:
        print(msg)
        show_information(m3, s3, sp1)

        for i in range(2):
            braking_control_msg = UInt16MultiArray()
            braking_control_msg.data = [25, 25, 25, 25, 1, 1, 0, 1]
