...
def show_information(m1, s1, sp1):
    if s1 == 1:
        s1 = "ON"
    else:
        s1 = "OFF"

    print('M1: {}% ({}) speed: {}'.format(m1, s1, sp1))
...
def main():
    ...
    try:
        print(msg)
        show_information(m1, s1, sp1)
        for i in range(2):
            braking_control_msg = UInt16MultiArray()
            braking_control_msg.data = [25, 25, 25, 25, 0, 1, 1, 1]
