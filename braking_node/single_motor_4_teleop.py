...
def show_information(m4, s4, sp1):
    if s4 == 1:
        s4 = "ON"
    else:
        s4 = "OFF"

    print('M4: {}% ({}) speed: {}'.format(m4, s4, sp1))
...
def main():
    ...
    try:
        print(msg)
        show_information(m4, s4, sp1)

        for i in range(2):
            braking_control_msg = UInt16MultiArray()
            braking_control_msg.data = [25, 25, 25, 25, 1, 1, 1, 0]
